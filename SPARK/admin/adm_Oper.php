...
<body class="bg-gray-200">
    ...
    <section class="page1 overflow-x-hidden">
                    ...
                    <ul class="flex flex-col gap-2">
                        ...
                        <div class="sidebar-item relative">
                            ...
                            <div id="dropdown-menu" class="dropdown-menu pl-7 flex flex-col text-xs pt-1 hidden">
                                ...
                                <a href="adm_Oper.php" class="dropdown-item py-1 text-gray-600 hover:text-black">Operator</a>
                ...
                <main class="container mx-auto px-4 mt-16 md:mt-24">
                    <div class="container-fluid px-4 py-4 card mb-4 bg-white rounded shadow mt-4">
                        <div class="flex justify-between items-center px-4">
                            <h1 class="mt-4 text-black text-2xl">All Operators</h1>
                                            ...
                                            <tr class="border-b hover:bg-gray-50">
                                                ...
                                                <td class="px-6 py-4">
                                                    <div class="flex items-center space-x-2 space-y-0">
                                                        <button class="edit-btn bg-blue-500 text-white w-10 h-10 rounded-lg flex items-center justify-center hover:bg-blue-600 transition" data-id="<?= $id_user; ?>">
                                                        ...
                                                        <form action="./control/hapusUser.php" method="GET" onsubmit="return confirm('Yakin ingin menghapus user ini?');">
                                                            <input type="hidden" name="id" value="<?= $id_user; ?>">
                                                            <button type="submit" class="text-red-500" class="bg-red-500 text-white w-8 h-8 rounded-lg flex items-center justify-center hover:bg-red-600 transition">
        ...
        <!--Jendela edit-->
        <div id="incidentModal" class="modal" style="display:none; position:fixed; z-index:1000; left:0; top:0; width:100%; height:100%; overflow:auto; background-color:rgba(0,0,0,0.4);">
            <div class="modal-content" style="background-color:#fefefe; margin:15% auto; padding:20px; border:1px solid #888; width:80%; max-width:500px;">
                ...
                <h2 style="font-weight: bold; text-align: center; font-size: 20px;">Edit Pengguna</h2>
                <form id="editForm" action="./control/updateUser.php" method="POST">
                    <input type="hidden" id="userId" name="id"> 
                                                        
                    <label for="fullName">Nama Lengkap</label>
                    <input type="text" id="fullName" name="employeePeng" placeholder="Masukkan Nama Lengkap" required>

                    <label for="username">Username Pengguna</label>
                    <input type="text" id="username" name="username" placeholder="Masukkan Username Pengguna" required>
        ...
        <div id="incidentModal" class="modal">
            <div class="modal-content">
                ...
                <form>
                    <label for="employeePeng">Nama Lengkap</label>
                    <input type="text" id="iya" name="employeePeng" placeholder="Masukkan Nama Lengkap" required>
                    ...
                    <input type="text" id="iya" name="plateTelepon" placeholder="Masukkan Nomor Telepon" required>
                ...
                button.addEventListener("click", function() {
                    ...
                    fetch(`getUser.php?id=${userId}`)
                        ...
                        .then(data => {
                            ...
                            document.getElementById("fullName").value = data.nama_lengkap;
                            document.getElementById("username").value = data.username;
                            document.getElementById("email").value = data.email;
                            document.getElementById("vehicleType").value = data.jenis_pengendara;
                            document.getElementById("phoneNumber").value = data.nomor_telepon;
